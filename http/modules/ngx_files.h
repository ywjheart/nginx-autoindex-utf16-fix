...
/* Windows defines MAX_PATH as 260 */
#define NGX_UTF8_BUFLEN  ((MAX_PATH-1)*4+1) /* utf-8 char takes at most 4 bytes for U+10FFFF range */
...
u_char *ngx_de_name(ngx_dir_t *dir);
size_t ngx_de_namelen(ngx_dir_t *dir);
